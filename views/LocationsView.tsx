            ...
            <InteractionCard borderColor={DESIGN_SYSTEM.colors.primary} className="!p-0 h-full overflow-hidden">
              <div className="flex flex-col h-full">
                <div className="w-full relative group overflow-hidden">
                  <OptimizedImage 
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuA-UKXNC-U7dc2fO-B0B9Cnyo3Dy8WyrvaMgN7UdSVnbGNkfu1shrCQzxAdNWCN31Bdwekwo0YAF7faiQ24E1yAIFDuSKdexMt3AnIcVeTIxtPDaB2BurM1lXhZdZeTtkhuuOJuODUbNt9qzZ6wnsGPcf3Ju_6sGx0Lqt74Q6tXSSAt7or1Z6VgPTaeRVNAvQpIBzr1BsD9iyEQ1hkSSlMwZCxIfKme-bJdXjdcdOM49lu_7uhVOaKqwo_nIi99pqAHaPakpbA4lNfb" 
                    alt="Sucursal Centro"
                  ...
                  <div className="absolute top-8 left-8 z-20">
                    <div className="bg-white/95 backdrop-blur-xl px-4 py-2 rounded-full shadow-lg flex items-center gap-2 border border-white/20">
                      ...
                      <span className={DESIGN_SYSTEM.typography.label + " !text-slate-800"}>Sucursal Centro</span>
                    </div>
                  </div>
                </div>
                <div className="p-8 md:p-10 flex flex-col flex-1 gap-10">
                  <div>
                    <h3 className={DESIGN_SYSTEM.typography.h3 + " mb-6"}>Ávila Camacho</h3>
                  ...
                  <div className="w-full aspect-square md:aspect-video rounded-[2.5rem] overflow-hidden border-8 border-white shadow-soft">
                    <iframe 
                ...
                <div className="w-full relative group overflow-hidden">
                  ...
                  <div className="absolute top-8 left-8 z-20">
                    <div className="bg-white/95 backdrop-blur-xl px-4 py-2 rounded-full shadow-lg flex items-center gap-2 border border-white/20">
                      ...
                      <span className={DESIGN_SYSTEM.typography.label + " !text-slate-800"}>Sucursal Américas</span>
                    </div>
                  </div>
                </div>
                <div className="p-8 md:p-10 flex flex-col flex-1 gap-10">
                  <div>
                    <h3 className={DESIGN_SYSTEM.typography.h3 + " mb-6"}>Av. Américas</h3>
                    <div className="flex items-start gap-4 p-5 bg-slate-50/50 rounded-2xl border border-slate-100 shadow-sm">
                  ...
                  <Magnetic pullStrength={0.1}>
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="w-full py-5 bg-slate-900 text-white rounded-full font-black font-display text-[10px] uppercase tracking-[0.2em] shadow-2xl hover:bg-jaci-yellow hover:text-slate-900 transition-all duration-500 flex items-center justify-center gap-2"
                    >
                      <span className="material-symbols-outlined text-sm">directions</span>
                      Ver en Google Maps
                    </a>
