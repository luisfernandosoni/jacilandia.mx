...
const AIChatWindow: React.FC<AIChatWindowProps> = ({ isOpen, onClose, currentView }) => {
  ...
  const handleSend = async () => {
    ...
    try {
      /**
       * Strategic Runtime Hydration:
       * Dynamically import the GenAI SDK ONLY when needed. 
       * This removes it from the critical main bundle path.
       */
  ...
  return (
    ...
    >
      <div className="p-6 bg-slate-900 text-white flex justify-between items-center shrink-0">
        ...
        <button onClick={onClose} className="w-8 h-8 rounded-full hover:bg-white/10 transition-colors flex items-center justify-center">
